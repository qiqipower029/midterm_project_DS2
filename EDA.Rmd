...
```{r histogram of response, include=FALSE}
...
summary(gam.fit.caret$finalModel)
```
...
```{r Partial dependence plots, include = FALSE}
...
```{r comparison between all models, include = FALSE}
##############################################################
