...
The final MARS model retained 7 predictors and 4 interaction terms. The predictors are: `sqft_living`, `grade`, `yr_built`, `sqft_living15`, `sqft_living`, `waterfront`, and `sqft_lot15`. Based on this MARS model, `sqft_living` seems to have interaction with `waterfront`, `grade` and `sqft_lot`. 
...
p4 <- partial(mars.fit, pred.var = c("sqft_lot"), grid.resolution = 10) %>% autoplot()
grid.arrange(p1, p2,p3, p4, ncol = 2)



p2 <- partial(mars.fit, pred.var = c("sqft_living", "sqft_lot"), grid.resolution = 10) %>% plotPartial(levelplot = FALSE, zlab = "yhat", drape = TRUE, 
